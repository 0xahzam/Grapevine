...
export default function Home() {
  ...
  return (
    <div className="main">
    <Flex position={"fixed"} top={"0"} width={"100%"} background={"#40434E"}  justifyItems={"center"} alignItems={"center"} flexDir={"row"} paddingTop={{base:"12px",md:"28px"}} paddingBottom={{base:"12px",md:"28px"}}>
      <Flex paddingLeft={{base:"20px",md:"140px"}} paddingRight={{base:"20px",md:"151px"}} justifyItems={"center"} alignItems={"center"} justifyContent={"space-between"} width={"100%"}>
        <Text color={"#DE89BE"} fontSize={{base:"24px",md:"32px"}} fontFamily={"Syne, sans-serif"} fontWeight={"700"} lineHeight={"38px"}>Grapevine</Text>
    ...
    <Flex flexDir={"column"} justifyItems={"center"} alignItems={"center"} justifyContent={"center"} height={"100vh"} color={"white"}>
      ...
      <Button marginTop={{base:"24px",md:"40px"}} background={"#DE89BE"} color={"black"} fontFamily={"Syne, sans-serif"} boxShadow={"3px 3px white"} border={"1px solid black"} lineHeight={"19.2px"} paddingRight={"32px"} paddingLeft={"32px"} paddingTop={"16px"} paddingBottom={"16px"} fontSize={"16px"} fontWeight={"bold"} width={"248px"} _hover={{background: "#C297B8"}}>Connect with twitter</Button>
      <Text fontFamily={"Urbanist, sans-serif"} fontSize={"12px"} fontWeight={"medium"} opacity={"70%"} width={"248px"} marginTop={"14px"} align={"center"} lineHeight={"14.4px"}>Twitter is only for verification and to prevent bots, your profile will be anonymous.</Text>
